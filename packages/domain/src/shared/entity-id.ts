...
export type InspectionSectionInstanceId = EntityId<'InspectionSectionInstance'>;
...
export const asInspectionSectionInstanceId = (value: string): InspectionSectionInstanceId => value as InspectionSectionInstanceId;
